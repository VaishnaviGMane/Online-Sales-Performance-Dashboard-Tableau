...
Payment Method Analysis
  ...
  2. How does each payment method contribute to total revenue?
Regional Sales Trends
   1.which countries/ regions generate the highest revenue?
   2.Are there geographical trends in sales distribution?
Product Insights
    1.which are the top 10 best selling products?
    2.which products need marketing support based on low sales?
Time Based Analysis
...
•	Paypal ranks second,while Debit card contributes less.
3.	Revenue By Region
•	The USA is the top revenue generating region.
•	Some countries show moderate performance,while others show very low sales.
4.	Top 10 Products
•	Canon EOS R5 Camera is the top performing product.
•	Other high sellers include LG OLED TV and MacBook Pro.
5.	Revenue Trend Over Time
•	Revenue fluctuates consistently, with noticeable peaks indicating promotions/ festive seasons.
...
4.	Integrate with power bi or python analytics for deeper insights.
5.	Develop profitability analysis(profit = revenue  – cost).
